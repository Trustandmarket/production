...
class UserCrudController extends AbstractCrudController
{
    ...
    public function deleteStripeId(Request $request): JsonResponse
    {
        ...
        if (($deletedItem['deleted'] ?? false) === true) {
            return new JsonResponse(['message' => 'Compte Stripe supprim� avec succ�s', 'delete' => $deletedItem], 200);
        }

        return new JsonResponse(['error' => '�chec de la suppression du compte Stripe', 'delete' => $deletedItem], 400);
    }
